...
USERS = {
    "U-001 — диспетчер, Москва": "U-001",
    "U-002 — диспетчер, Санкт-Петербург": "U-002",
    "U-008 — сервис-менеджер, Москва + Санкт-Петербург": "U-008",
    "U-019 — представитель партнёра CUST-008": "U-019",
    "U-020 — представитель партнёра CUST-009": "U-020",
}
...
with st.sidebar:
    ...
    with st.expander("Access Control demo"):
        st.caption(
            "U-001 — чужая территория → deny\n\n"
            "U-002 — сотрудник SPB → full access\n\n"
            "U-019 — свой партнёр → обращение и оборудование видны, трассировка скрыта\n\n"
            "U-020 — другой партнёр → deny\n\n"
            "U-008 — менеджер MSK + SPB → staff access"
        )
