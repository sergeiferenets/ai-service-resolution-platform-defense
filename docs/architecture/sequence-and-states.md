...
sequenceDiagram
    ...
    Note over ORC: Идентификация и поиск выполнены<br/>Код HP 49.xx
    ORC->>RE: Применить правила к проверенным фактам
    RE-->>ORC: R-06, requires_evaluation<br/>route и prescribed actions из каталога
    ORC->>PA: Минимальный PolicyCase для R-06
